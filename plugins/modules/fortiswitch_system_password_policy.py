...
def fortiswitch_system(data, fos):
    ...
    fos.do_member_operation('system_password_policy')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["system_password_policy"]['options'][attribute_name] = module_spec['options'][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["system_password_policy"]['options'][attribute_name]['required'] = True
        if is_secret_field(attribute_name):
            fields["system_password_policy"]['options'][attribute_name]['no_log'] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "system_password_policy")
