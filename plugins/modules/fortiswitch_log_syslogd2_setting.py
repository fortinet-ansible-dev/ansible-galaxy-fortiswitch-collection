...
DOCUMENTATION = '''
---
module: fortiswitch_log_syslogd2_setting
...
options:
    ...
    log_syslogd2_setting:
        ...
        suboptions:
            certificate:
                description:
                    - Certificate used to communicate with Syslog server. Source system.certificate.local.name.
                type: str
            csv:
                description:
...
def fortiswitch_log_syslogd2(data, fos):

    fos.do_member_operation('log_syslogd2_setting')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["log_syslogd2_setting"]['options'][attribute_name] = module_spec['options'][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["log_syslogd2_setting"]['options'][attribute_name]['required'] = True
        if is_secret_field(attribute_name):
            fields["log_syslogd2_setting"]['options'][attribute_name]['no_log'] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "log_syslogd2_setting")

        is_error, has_changed, result = fortiswitch_log_syslogd2(module.params, fos)
