...
DOCUMENTATION = '''
---
module: fortiswitch_log_syslogd_filter
...
def fortiswitch_log_syslogd(data, fos):
    ...
    fos.do_member_operation('log_syslogd_filter')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["log_syslogd_filter"]['options'][attribute_name] = module_spec['options'][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["log_syslogd_filter"]['options'][attribute_name]['required'] = True
        if is_secret_field(attribute_name):
            fields["log_syslogd_filter"]['options'][attribute_name]['no_log'] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "log_syslogd_filter")
