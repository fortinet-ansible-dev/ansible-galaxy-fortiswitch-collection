...
def filter_switch_virtual_wire_data(json):
    option_list = ["first_member", "name", "second_member", "vlan"]
...
def switch_virtual_wire(data, fos, check_mode=False):
    ...
    if state == "present" or state is True:
        ...
        return fos.delete("switch", "virtual-wire", mkey=filtered_data["name"])
    else:
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["switch_virtual_wire"]["options"][attribute_name] = module_spec[
            "options"
        ][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "switch_virtual_wire"
        )
