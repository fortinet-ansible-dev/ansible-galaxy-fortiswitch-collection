...
def fortiswitch_system(data, fos):
    ...
    fos.do_member_operation('system_location')
    current_cmdb_index = fos.monitor_get('/system/status')['cmdb-index']
    if data['system_location']:
        resp = system_location(data, fos)
    else:
...
def main():
    ...
    for attribute_name in module_spec['options']:
        ...
        if is_secret_field(attribute_name):
            fields["system_location"]['options'][attribute_name]['no_log'] = True
