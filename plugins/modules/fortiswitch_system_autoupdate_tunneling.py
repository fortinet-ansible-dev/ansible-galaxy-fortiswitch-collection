...
def system_autoupdate_tunneling(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey('system.autoupdate', 'tunneling', filtered_data)
        current_data = fos.get('system.autoupdate', 'tunneling', mkey=mkey)
...
versioned_schema = {
    ...
    "children": {
        "status": {
            ...
            "name": "status",
            "help": "Enable/disable web proxy tunneling.",
            "category": "unitary"
        },
        "username": {
            "v_range": [
            ...
            "type": "string",
            "name": "username",
            "help": "Configure the web proxy username.",
            "category": "unitary"
        },
        "password": {
            "v_range": [
            ...
            "type": "string",
            "name": "password",
            "help": "Configure the web proxy password.",
            "category": "unitary"
        },
        "port": {
            "v_range": [
            ...
            "type": "integer",
            "name": "port",
            "help": "Configure the web proxy port.",
            "category": "unitary"
        },
        "address": {
            "v_range": [
            ...
            "type": "string",
            "name": "address",
            "help": "Configure the web proxy ip address or fqdn.",
            "category": "unitary"
        }
    },
    "name": "tunneling",
    "help": "Configure web proxy tunneling for the FDN.",
    "category": "complex"
}
