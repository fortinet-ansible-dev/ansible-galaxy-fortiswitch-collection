...
def switch_acl_service_custom(data, fos):
...
def fortiswitch_switch_acl_service(data, fos):

    fos.do_member_operation('switch_acl_service_custom')
    current_cmdb_index = fos.monitor_get('/system/status')['cmdb-index']
    if data['switch_acl_service_custom']:
        resp = switch_acl_service_custom(data, fos)
    else:
...
def main():
    ...
    for attribute_name in module_spec['options']:
        ...
        if is_secret_field(attribute_name):
            fields["switch_acl_service_custom"]['options'][attribute_name]['no_log'] = True
    ...
    if module._socket_path:
        ...
        is_error, has_changed, result = fortiswitch_switch_acl_service(module.params, fos)
