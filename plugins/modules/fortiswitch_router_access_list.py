...
def router_access_list(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey("router", "access-list", filtered_data)
        current_data = fos.get("router", "access-list", mkey=mkey)
        is_existed = (
            current_data
    ...
    if state == "present" or state is True:
        ...
        return fos.delete("router", "access-list", mkey=filtered_data["name"])
    else:
...
def fortiswitch_router(data, fos, check_mode):
    fos.do_member_operation("router", "access-list")
...
versioned_schema = {
    ...
    "children": {
        "rule": {
            ...
            "children": {
                ...
                "prefix": {
                    ...
                    "type": "string",
                    "name": "prefix",
                    "help": "Prefix to define regular filter criteria,such as any or subnets.",
                    "category": "unitary",
                },
                "flags": {
                    "v_range": [["v7.0.0", ""]],
        ...
        "name": {
            ...
            "type": "string",
            "name": "name",
            "help": "Name. For creating Cisco wild-card access-list,name should be a digit within range <1-99>.",
            "category": "unitary",
        },
        "comments": {
            "v_range": [["v7.0.0", ""]],
    ...
    "v_range": [["v7.0.0", ""]],
    "name": "access-list",
    "help": "Access list configuration.",
    "mkey": "name",
    "category": "table",
}
