...
def system_alertemail(data, fos, check_mode=False):
    state = data.get("state", None)

    system_alertemail_data = data["system_alertemail"]

    filtered_data = filter_system_alertemail_data(system_alertemail_data)
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey("system", "alertemail", filtered_data)
        current_data = fos.get("system", "alertemail", mkey=mkey)
        is_existed = (
            current_data
...
def fortiswitch_system(data, fos, check_mode):
    ...
    if data["system_alertemail"]:
        resp = system_alertemail(data, fos, check_mode)
    else:
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["system_alertemail"]["options"][attribute_name] = module_spec["options"][
            attribute_name
        ]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "system_alertemail"
        )
