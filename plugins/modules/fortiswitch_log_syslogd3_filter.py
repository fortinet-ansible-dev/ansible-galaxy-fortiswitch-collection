...
DOCUMENTATION = '''
---
module: fortiswitch_log_syslogd3_filter
...
def log_syslogd3_filter(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey('log.syslogd3', 'filter', filtered_data)
        current_data = fos.get('log.syslogd3', 'filter', mkey=mkey)
...
def fortiswitch_log_syslogd3(data, fos, check_mode):
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["log_syslogd3_filter"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "log_syslogd3_filter")
        is_error, has_changed, result, diff = fortiswitch_log_syslogd3(module.params, fos, module.check_mode)
    else:
