...
def fortiswitch_log_syslogd3(data, fos):
    ...
    fos.do_member_operation('log_syslogd3_filter')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        ...
        if is_secret_field(attribute_name):
            fields["log_syslogd3_filter"]['options'][attribute_name]['no_log'] = True
    ...
    if module._socket_path:
        ...
        is_error, has_changed, result = fortiswitch_log_syslogd3(module.params, fos)
