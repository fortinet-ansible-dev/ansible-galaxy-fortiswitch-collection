...
def router_gwdetect(data, fos, check_mode=False):
    ...
    filtered_data = filter_router_gwdetect_data(router_gwdetect_data)
    ...
    if state == "present" or state is True:
        ...
        return fos.delete("router", "gwdetect", mkey=filtered_data["interface"])
    else:
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["router_gwdetect"]["options"][attribute_name] = module_spec["options"][
            attribute_name
        ]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "router_gwdetect"
        )
