         ...
         -
             ...
             -
                ...
                virtual_link:
                 -
                    ...
                    peer: "<your_own_value>"
                    retransmit_interval: "112"
                    transmit_delay: "113"
            database_overflow: "enable"
            database_overflow_max_external_lsa: "115"
            database_overflow_time_to_recover: "116"
            default_information_metric: "117"
            default_information_metric_type: "1"
            default_information_originate: "enable"
            distance: "120"
            distance_external: "121"
            distance_inter_area: "122"
            distance_intra_area: "123"
            distribute_list:
             -
                access_list: "<your_own_value> (source router.access-list.name)"
                id:  "126"
            ...
            interface:
             -
                ...
                priority: "141"
                retransmit_interval: "142"
                transmit_delay: "143"
            log_neighbour_changes: "enable"
            name: "default_name_145 (source router.vrf.name)"
            network:
             -
                area: "<your_own_value>"
                id:  "148"
            ...
            passive_interface:
             -
                name: "default_name_151 (source system.interface.name)"
            redistribute:
             -
                metric: "153"
                metric_type: "1"
                name: "default_name_155"
                routemap: "<your_own_value> (source router.route-map.name)"
                status: "enable"
                tag: "158"
            rfc1583_compatible: "enable"
