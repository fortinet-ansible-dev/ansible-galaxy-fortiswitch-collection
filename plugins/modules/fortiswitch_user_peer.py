...
options:
    ...
    user_peer:
        ...
        suboptions:
            ca:
                description:
                    - peer certificate CA (CA name in local) Source system.certificate.ca.name.
                type: str
            cn:
                description:
            ...
            ldap_server:
                description:
                    - LDAP server for access rights check Source user.ldap.name.
                type: str
            ldap_username:
                description:
...
def fortiswitch_user(data, fos):
    ...
    fos.do_member_operation('user_peer')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        ...
        if is_secret_field(attribute_name):
            fields["user_peer"]['options'][attribute_name]['no_log'] = True
