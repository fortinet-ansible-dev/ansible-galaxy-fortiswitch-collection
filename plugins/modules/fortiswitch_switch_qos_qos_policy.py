...
def switch_qos_qos_policy(data, fos, check_mode=False):
    ...
    filtered_data = filter_switch_qos_qos_policy_data(switch_qos_qos_policy_data)
    ...
    if state == "present" or state is True:
        ...
        return fos.delete("switch.qos", "qos-policy", mkey=filtered_data["name"])
    else:
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["switch_qos_qos_policy"]["options"][attribute_name] = module_spec[
            "options"
        ][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["switch_qos_qos_policy"]["options"][attribute_name][
                "required"
            ] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "switch_qos_qos_policy"
        )
