...
def fortiswitch_log_fortianalyzer3(data, fos):
...
def main():
    ...
    if module._socket_path:
        ...
        is_error, has_changed, result, diff = fortiswitch_log_fortianalyzer3(module.params, fos)
    else:
