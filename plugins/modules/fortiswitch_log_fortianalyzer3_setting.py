...
options:
    ...
    log_fortianalyzer3_setting:
        ...
        suboptions:
            ...
            fdp_interface:
                description:
                    - Interface for FortiAnalyzer auto-discovery. Source system.interface.name.
                type: str
            hmac_algorithm:
                description:
...
def fortiswitch_log_fortianalyzer3(data, fos):
    ...
    fos.do_member_operation('log_fortianalyzer3_setting')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        ...
        if is_secret_field(attribute_name):
            fields["log_fortianalyzer3_setting"]['options'][attribute_name]['no_log'] = True
    ...
    if module._socket_path:
        ...
        is_error, has_changed, result = fortiswitch_log_fortianalyzer3(module.params, fos)
