...
def fortiswitch_log_memory(data, fos):
    ...
    fos.do_member_operation('log_memory_global_setting')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        ...
        if is_secret_field(attribute_name):
            fields["log_memory_global_setting"]['options'][attribute_name]['no_log'] = True
    ...
    if module._socket_path:
        ...
        is_error, has_changed, result = fortiswitch_log_memory(module.params, fos)
