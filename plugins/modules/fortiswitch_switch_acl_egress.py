...
def switch_acl_egress(data, fos, check_mode=False):
    ...
    filtered_data = filter_switch_acl_egress_data(switch_acl_egress_data)
    ...
    if state == "present" or state is True:
        ...
        return fos.delete("switch.acl", "egress", mkey=filtered_data["id"])
    else:
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["switch_acl_egress"]["options"][attribute_name] = module_spec["options"][
            attribute_name
        ]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "switch_acl_egress"
        )
