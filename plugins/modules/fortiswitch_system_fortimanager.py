...
DOCUMENTATION = '''
---
module: fortiswitch_system_fortimanager
short_description: FortiManagerconfiguration in Fortinet's FortiSwitch
description:
...
def filter_system_fortimanager_data(json):
    option_list = ['central_mgmt_auto_backup', 'central_mgmt_schedule_config_restore', 'central_mgmt_schedule_script_restore',
                   'ip', 'ipsec']
...
def system_fortimanager(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey('system', 'fortimanager', filtered_data)
        current_data = fos.get('system', 'fortimanager', mkey=mkey)
...
versioned_schema = {
    ...
    "children": {
        ...
        "central_mgmt_schedule_config_restore": {
            ...
            "name": "central-mgmt-schedule-config-restore",
        ...
        "central_mgmt_schedule_script_restore": {
            ...
            "name": "central-mgmt-schedule-script-restore",
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["system_fortimanager"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "system_fortimanager")
