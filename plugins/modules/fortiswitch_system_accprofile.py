        ...
        suboptions:
            ...
            alias_commands:
                ...
                suboptions:
                    command_name:
                        description:
                            - Alias command or group name. Source system.alias.command.name system.alias.group.name.
                        type: str
            exec_alias_grp:
                description:
...
def fortiswitch_system(data, fos):
    ...
    fos.do_member_operation('system_accprofile')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        ...
        if is_secret_field(attribute_name):
            fields["system_accprofile"]['options'][attribute_name]['no_log'] = True
