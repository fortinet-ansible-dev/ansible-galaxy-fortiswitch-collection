...
def fortiswitch_switch_mld_snooping(data, fos):
    ...
    fos.do_member_operation('switch_mld_snooping_globals')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        ...
        if is_secret_field(attribute_name):
            fields["switch_mld_snooping_globals"]['options'][attribute_name]['no_log'] = True
    ...
    if module._socket_path:
        ...
        is_error, has_changed, result = fortiswitch_switch_mld_snooping(module.params, fos)
