...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["system_fortianalyzer2"]["options"][attribute_name] = module_spec[
            "options"
        ][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["system_fortianalyzer2"]["options"][attribute_name][
                "required"
            ] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "system_fortianalyzer2"
        )
