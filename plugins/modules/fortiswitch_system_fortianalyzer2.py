...
def system_fortianalyzer2(data, fos):
    system_fortianalyzer2_data = data['system_fortianalyzer2']
    filtered_data = underscore_to_hyphen(filter_system_fortianalyzer2_data(system_fortianalyzer2_data))
...
def fortiswitch_system(data, fos):
    ...
    fos.do_member_operation('system_fortianalyzer2')
    current_cmdb_index = fos.monitor_get('/system/status')['cmdb-index']
    if data['system_fortianalyzer2']:
        resp = system_fortianalyzer2(data, fos)
    else:
...
def main():
    ...
    for attribute_name in module_spec['options']:
        ...
        if is_secret_field(attribute_name):
            fields["system_fortianalyzer2"]['options'][attribute_name]['no_log'] = True
