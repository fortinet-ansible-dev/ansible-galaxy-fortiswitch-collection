...
def system_certificate_crl(data, fos, check_mode=False):
    ...
    filtered_data = filter_system_certificate_crl_data(system_certificate_crl_data)
    ...
    if state == "present" or state is True:
        ...
        return fos.delete("system.certificate", "crl", mkey=filtered_data["name"])
    else:
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["system_certificate_crl"]["options"][attribute_name] = module_spec[
            "options"
        ][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["system_certificate_crl"]["options"][attribute_name][
                "required"
            ] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "system_certificate_crl"
        )
