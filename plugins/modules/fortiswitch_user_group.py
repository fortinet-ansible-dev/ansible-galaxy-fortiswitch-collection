...
def user_group(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey("user", "group", filtered_data)
        current_data = fos.get("user", "group", mkey=mkey)
        is_existed = (
            current_data
    ...
    if state == "present" or state is True:
        ...
        return fos.delete("user", "group", mkey=filtered_data["name"])
    else:
