...
def switch_physical_port(data, fos):
...
def fortiswitch_switch(data, fos):
    ...
    fos.do_member_operation('switch_physical_port')
    current_cmdb_index = fos.monitor_get('/system/status')['cmdb-index']
    if data['switch_physical_port']:
        resp = switch_physical_port(data, fos)
    else:
...
def main():
    ...
    for attribute_name in module_spec['options']:
        ...
        if is_secret_field(attribute_name):
            fields["switch_physical_port"]['options'][attribute_name]['no_log'] = True
