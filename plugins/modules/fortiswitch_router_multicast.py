        ...
        suboptions:
            interface:
                ...
                suboptions:
                    ...
                    multicast_flow:
                        description:
                            - Config acceptable source for multicast group. Source router.multicast-flow.name.
                        type: str
                    name:
                        description:
...
def fortiswitch_router(data, fos):
    ...
    fos.do_member_operation('router_multicast')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        ...
        if is_secret_field(attribute_name):
            fields["router_multicast"]['options'][attribute_name]['no_log'] = True
