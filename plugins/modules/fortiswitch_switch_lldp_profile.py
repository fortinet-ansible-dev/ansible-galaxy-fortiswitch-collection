...
def switch_lldp_profile(data, fos, check_mode=False):
    ...
    filtered_data = filter_switch_lldp_profile_data(switch_lldp_profile_data)
    ...
    if state == "present" or state is True:
        ...
        return fos.delete("switch.lldp", "profile", mkey=filtered_data["name"])
    else:
...
versioned_schema = {
    ...
    "children": {
        ...
        "tlvs_802dot1": {
            ...
            "options": [
                {"value": "port-vlan-id"},
                {"value": "vlan-name", "v_range": [["v7.2.1", ""]]},
            ],
            "name": "802.1-tlvs",
        ...
        "auto_isl_auth_encrypt": {
            ...
            "options": [
                {"value": "none"},
                {"value": "must", "v_range": [["v7.4.1", ""]]},
                {"value": "mixed", "v_range": [["v7.4.1", ""]]},
            ],
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["switch_lldp_profile"]["options"][attribute_name] = module_spec[
            "options"
        ][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "switch_lldp_profile"
        )
