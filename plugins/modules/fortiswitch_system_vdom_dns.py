...
DOCUMENTATION = '''
---
module: fortiswitch_system_vdom_dns
short_description: Vdom dns configuration in Fortinet's FortiSwitch
description:
...
def system_vdom_dns(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey('system', 'vdom-dns', filtered_data)
        current_data = fos.get('system', 'vdom-dns', mkey=mkey)
...
versioned_schema = {
    ...
    "children": {
        "vdom_dns": {
            ...
            "name": "vdom-dns",
            "help": "Enable/Disable dns per vdom.",
            "category": "unitary"
        },
        "source_ip": {
            "v_range": [
            ...
            "type": "string",
            "name": "source-ip",
            "help": "Source IP for communications to DNS server.",
            "category": "unitary"
        },
        "primary": {
            "v_range": [
        ...
        "ip6_secondary": {
            ...
            "type": "string",
            "name": "ip6-secondary",
            "help": "Vdom IPv6 seondary dns ip.",
            "category": "unitary"
        },
        "ip6_primary": {
            "v_range": [
        ...
        "secondary": {
            ...
            "type": "string",
            "name": "secondary",
            "help": "Vdom secondary dns ip.",
            "category": "unitary"
        }
    },
    "name": "vdom-dns",
    "help": "Vdom dns configuration.",
    "category": "complex"
}
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["system_vdom_dns"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "system_vdom_dns")
