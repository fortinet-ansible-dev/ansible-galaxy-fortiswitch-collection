...
options:
    ...
    switch_acl_prelookup:
        ...
        suboptions:
            ...
            interface:
                description:
                    - Interface to which policy is bound in the pre-lookup. Source switch.physical-port.name.
                type: str
            schedule:
                description:
                    - schedule list.
...
def switch_acl_prelookup(data, fos):
...
def fortiswitch_switch_acl(data, fos):
    ...
    fos.do_member_operation('switch_acl_prelookup')
    current_cmdb_index = fos.monitor_get('/system/status')['cmdb-index']
    if data['switch_acl_prelookup']:
        resp = switch_acl_prelookup(data, fos)
    else:
...
def main():
    ...
    for attribute_name in module_spec['options']:
        ...
        if is_secret_field(attribute_name):
            fields["switch_acl_prelookup"]['options'][attribute_name]['no_log'] = True
