...
def system_web(data, fos):
    system_web_data = data['system_web']
    filtered_data = underscore_to_hyphen(filter_system_web_data(system_web_data))
