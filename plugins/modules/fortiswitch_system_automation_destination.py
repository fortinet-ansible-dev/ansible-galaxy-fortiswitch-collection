...
def system_automation_destination(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey("system", "automation-destination", filtered_data)
        current_data = fos.get("system", "automation-destination", mkey=mkey)
        is_existed = (
            current_data
    ...
    if state == "present" or state is True:
        ...
        return fos.delete(
            "system", "automation-destination", mkey=filtered_data["name"]
        )
    else:
