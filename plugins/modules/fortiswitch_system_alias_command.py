...
def system_alias_command(data, fos, check_mode=False):
    ...
    if state == "present" or state is True:
        ...
        return fos.delete("system.alias", "command", mkey=filtered_data["name"])
    else:
...
versioned_schema = {
    ...
    "children": {
        ...
        "permission": {
            "v_range": [["v7.0.0", ""]],
            "type": "string",
            "options": [{"value": "read"}, {"value": "read-write"}],
            "name": "permission",
        ...
        "type": {
            "v_range": [["v7.0.0", ""]],
            "type": "string",
            "options": [{"value": "configuration"}, {"value": "script"}],
            "name": "type",
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["system_alias_command"]["options"][attribute_name] = module_spec[
            "options"
        ][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "system_alias_command"
        )
        is_error, has_changed, result, diff = fortiswitch_system_alias(
