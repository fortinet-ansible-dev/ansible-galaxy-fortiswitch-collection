...
DOCUMENTATION = '''
---
module: fortiswitch_log_fortianalyzer3_filter
...
def log_fortianalyzer3_filter(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey('log.fortianalyzer3', 'filter', filtered_data)
        current_data = fos.get('log.fortianalyzer3', 'filter', mkey=mkey)
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["log_fortianalyzer3_filter"]['options'][attribute_name] = module_spec['options'][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["log_fortianalyzer3_filter"]['options'][attribute_name]['required'] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "log_fortianalyzer3_filter")
