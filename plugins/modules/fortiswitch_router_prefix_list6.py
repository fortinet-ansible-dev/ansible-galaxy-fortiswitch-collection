...
def router_prefix_list6(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey("router", "prefix-list6", filtered_data)
        current_data = fos.get("router", "prefix-list6", mkey=mkey)
        is_existed = (
            current_data
    ...
    if state == "present" or state is True:
        ...
        return fos.delete("router", "prefix-list6", mkey=filtered_data["name"])
    else:
