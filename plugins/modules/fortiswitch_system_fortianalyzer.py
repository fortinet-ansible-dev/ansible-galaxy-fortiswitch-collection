...
def system_fortianalyzer(data, fos, check_mode=False):
    state = data.get("state", None)

    system_fortianalyzer_data = data["system_fortianalyzer"]

    filtered_data = filter_system_fortianalyzer_data(system_fortianalyzer_data)
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey("system", "fortianalyzer", filtered_data)
        current_data = fos.get("system", "fortianalyzer", mkey=mkey)
        is_existed = (
            current_data
...
def fortiswitch_system(data, fos, check_mode):
    ...
    if data["system_fortianalyzer"]:
        resp = system_fortianalyzer(data, fos, check_mode)
    else:
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["system_fortianalyzer"]["options"][attribute_name] = module_spec[
            "options"
        ][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "system_fortianalyzer"
        )
