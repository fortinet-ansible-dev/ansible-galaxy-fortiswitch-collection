...
DOCUMENTATION = '''
---
module: fortiswitch_system_dns
short_description: Configure DNS in Fortinet's FortiSwitch
description:
    ...
    system_dns:
        ...
        suboptions:
            cache_notfound_responses:
                description:
                    - Enable/disable caching of NOTFOUND responses from DNS server.
                type: str
                choices:
                    - 'disable'
                    - 'enable'
            ...
            ip6_primary:
                description:
                    - IPv6 address for primary DNS server.
                type: str
            ip6_secondary:
                description:
                    - IPv6 address for secondary DNS server.
                type: str
            primary:
                description:
...
def system_dns(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey('system', 'dns', filtered_data)
        current_data = fos.get('system', 'dns', mkey=mkey)
...
versioned_schema = {
    ...
    "children": {
        ...
        "dns_cache_ttl": {
            ...
            "type": "integer",
            "name": "dns-cache-ttl",
            "help": "TTL in DNS cache (60 - 86400).",
            "category": "unitary"
        },
        "primary": {
            "v_range": [
            ...
            "type": "string",
            "name": "primary",
            "help": "IP address for primary DNS server.",
            "category": "unitary"
        },
        "dns_cache_limit": {
            "v_range": [
            ...
            "help": "Maximum number of entries in DNS cache.",
            "category": "unitary"
        },
        "cache_notfound_responses": {
            "v_range": [
            ...
            "help": "Enable/disable caching of NOTFOUND responses from DNS server.",
            "category": "unitary"
        },
        "ip6_secondary": {
            "v_range": [
            ...
            "type": "string",
            "name": "ip6-secondary",
            "help": "IPv6 address for secondary DNS server.",
            "category": "unitary"
        },
        "ip6_primary": {
            "v_range": [
            ...
            "type": "string",
            "name": "ip6-primary",
            "help": "IPv6 address for primary DNS server.",
            "category": "unitary"
        },
        "source_ip": {
            "v_range": [
            ...
            "type": "string",
            "name": "source-ip",
            "help": "Source IP for DNS queries.",
            "category": "unitary"
        },
        "secondary": {
            "v_range": [
            ...
            "type": "string",
            "name": "secondary",
            "help": "IP address for secondary DNS server.",
            "category": "unitary"
        }
    },
    "name": "dns",
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["system_dns"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "system_dns")
