...
def filter_switch_acl_802_1x_data(json):
    option_list = ["access_list_entry", "description", "filter_id", "id"]
...
def switch_acl_802_1x(data, fos, check_mode=False):
    ...
    if state == "present" or state is True:
        ...
        return fos.delete("switch.acl", "802-1X", mkey=filtered_data["id"])
    else:
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["switch_acl_802_1x"]["options"][attribute_name] = module_spec["options"][
            attribute_name
        ]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "switch_acl_802_1x"
        )
