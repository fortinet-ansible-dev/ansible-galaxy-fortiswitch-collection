...
def filter_switch_global_data(json):
    option_list = ['auto_fortilink_discovery', 'auto_isl', 'auto_isl_port_group',
                   ...
                   'mclag_peer_info_timeout', 'mclag_port_base', 'mclag_split_brain_detect',
                   'mclag_stp_aware', 'mirror_qos', 'name',
                   'poe_alarm_threshold', 'poe_guard_band', 'poe_power_budget',
                   'poe_power_mode', 'poe_pre_standard_detect', 'port_security',
                   'trunk_hash_mode', 'trunk_hash_unicast_src_port', 'trunk_hash_unkunicast_src_dst',
                   'virtual_wire_tpid']
    dictionary = {}
