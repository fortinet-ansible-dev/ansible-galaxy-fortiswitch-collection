...
DOCUMENTATION = '''
---
module: fortiswitch_system_zone
short_description: Zone configuration in Fortinet's FortiSwitch
description:
...
def system_zone(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey('system', 'zone', filtered_data)
        current_data = fos.get('system', 'zone', mkey=mkey)
...
def fortiswitch_system(data, fos, check_mode):
    fos.do_member_operation('system', 'zone')
...
versioned_schema = {
    ...
    "children": {
        "interface": {
            ...
            "name": "interface",
            "help": "Interfaces belong to the zone.",
            "mkey": "interface_name",
            "category": "table"
        },
        "intrazone": {
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["system_zone"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "system_zone")
