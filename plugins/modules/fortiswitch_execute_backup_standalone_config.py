...
def backup_standalone_config(data, fos):
    ...
    filtered_data = underscore_to_hyphen(
        filter_backup_standalone_config_data(backup_standalone_config_data)
    )
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["execute_backup_standalone_config"]["options"][attribute_name] = (
    ...
    if module._socket_path:
        ...
        is_error, has_changed, result = fortiswitch_execute_backup_standalone_config(
            module.params, fos
        )
    else:
