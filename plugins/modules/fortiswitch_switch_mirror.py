...
def switch_mirror(data, fos, check_mode=False):
    ...
    if state == "present" or state is True:
        ...
        return fos.delete("switch", "mirror", mkey=filtered_data["name"])
    else:
...
versioned_schema = {
    ...
    "children": {
        ...
        "encap_vlan": {
            "v_range": [["v7.0.0", ""]],
            "type": "string",
            "options": [{"value": "tagged"}, {"value": "untagged"}],
            "name": "encap-vlan",
        ...
        "mode": {
            ...
            "options": [
                ...
                {"value": "ERSPAN-manual"},
                {"value": "ERSPAN-auto"},
                {"value": "RSPAN-manual", "v_range": [["v7.2.1", ""]]},
                {"value": "RSPAN-auto", "v_range": [["v7.2.1", ""]]},
            ],
            "name": "mode",
            "help": "Mirroring mode.",
            "category": "unitary",
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["switch_mirror"]["options"][attribute_name] = module_spec["options"][
            attribute_name
        ]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "switch_mirror"
        )
