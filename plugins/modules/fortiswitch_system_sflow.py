...
DOCUMENTATION = '''
---
module: fortiswitch_system_sflow
short_description: Configure sFlow in Fortinet's FortiSwitch
description:
...
def system_sflow(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey('system', 'sflow', filtered_data)
        current_data = fos.get('system', 'sflow', mkey=mkey)
...
def fortiswitch_system(data, fos, check_mode):
    fos.do_member_operation('system', 'sflow')
        ...
        "collectors": {
            ...
            "children": {
                ...
                "port": {
                    ...
                    "type": "integer",
                    "name": "port",
                    "help": "SFlow collector port (0 - 65535).",
                    "category": "unitary"
                }
            },
            "v_range": [
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["system_sflow"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "system_sflow")
