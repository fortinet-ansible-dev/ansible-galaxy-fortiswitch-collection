...
options:
    ...
    user_ldap:
        ...
        suboptions:
            ca_cert:
                description:
                    - CA certificate name. Source system.certificate.ca.name.
                type: str
            cnid:
                description:
            ...
            port:
                description:
                    - LDAP server port number (1 - 65535).
                type: int
            secure:
                description:
                    - SSL connection.
...
def fortiswitch_user(data, fos):
    ...
    fos.do_member_operation('user_ldap')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        ...
        if is_secret_field(attribute_name):
            fields["user_ldap"]['options'][attribute_name]['no_log'] = True
