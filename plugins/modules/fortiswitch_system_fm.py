...
DOCUMENTATION = '''
---
module: fortiswitch_system_fm
short_description: Fm in Fortinet's FortiSwitch
description:
...
def system_fm(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey('system', 'fm', filtered_data)
        current_data = fos.get('system', 'fm', mkey=mkey)
...
versioned_schema = {
    ...
    "children": {
        ...
        "scheduled_config_restore": {
            ...
            "name": "scheduled-config-restore",
            "help": "Scheduled-config-restore.",
            "category": "unitary"
        },
        "id": {
            "v_range": [
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["system_fm"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "system_fm")
