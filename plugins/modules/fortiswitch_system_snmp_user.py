...
def filter_system_snmp_user_data(json):
    option_list = ['auth_proto', 'auth_pwd', 'events',
                   'name', 'notify_hosts', 'priv_proto',
                   'priv_pwd', 'queries', 'query_port',
                   'security_level']
    dictionary = {}
...
def fortiswitch_system_snmp(data, fos):
    ...
    fos.do_member_operation('system_snmp_user')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["system_snmp_user"]['options'][attribute_name] = module_spec['options'][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["system_snmp_user"]['options'][attribute_name]['required'] = True
        if is_secret_field(attribute_name):
            fields["system_snmp_user"]['options'][attribute_name]['no_log'] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "system_snmp_user")
