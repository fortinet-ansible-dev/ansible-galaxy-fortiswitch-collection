...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["switch_ptp_settings"]["options"][attribute_name] = module_spec[
            "options"
        ][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(
            fos, versioned_schema, "switch_ptp_settings"
        )
        is_error, has_changed, result, diff = fortiswitch_switch_ptp(
