...
def switch_qos_ip_dscp_map(data, fos):

    state = data['state']

    switch_qos_ip_dscp_map_data = data['switch_qos_ip_dscp_map']
    filtered_data = underscore_to_hyphen(filter_switch_qos_ip_dscp_map_data(switch_qos_ip_dscp_map_data))
...
def fortiswitch_switch_qos(data, fos):
    ...
    fos.do_member_operation('switch_qos_ip_dscp_map')
    current_cmdb_index = fos.monitor_get('/system/status')['cmdb-index']
    if data['switch_qos_ip_dscp_map']:
        resp = switch_qos_ip_dscp_map(data, fos)
    else:
...
def main():
    ...
    for attribute_name in module_spec['options']:
        ...
        if is_secret_field(attribute_name):
            fields["switch_qos_ip_dscp_map"]['options'][attribute_name]['no_log'] = True
