...
DOCUMENTATION = '''
---
module: fortiswitch_system_console
short_description: Configure console in Fortinet's FortiSwitch
description:
...
def system_console(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey('system', 'console', filtered_data)
        current_data = fos.get('system', 'console', mkey=mkey)
...
versioned_schema = {
    ...
    "children": {
        ...
        "hostname_display_length": {
            ...
            "type": "integer",
            "name": "hostname-display-length",
            "help": "CLI prompt hostname display length.",
            "category": "unitary"
        },
        "login": {
            "v_range": [
            ...
            "name": "login",
            "help": "Enable/disable console login.",
            "category": "unitary"
        }
    },
    "name": "console",
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["system_console"]['options'][attribute_name] = module_spec['options'][attribute_name]
