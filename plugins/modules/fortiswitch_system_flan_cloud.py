...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["system_flan_cloud"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "system_flan_cloud")
