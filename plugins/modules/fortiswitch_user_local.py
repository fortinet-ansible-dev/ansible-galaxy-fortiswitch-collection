...
options:
    ...
    user_local:
        ...
        suboptions:
            ...
            radius_server:
                description:
                    - RADIUS server name. Source user.radius.name.
                type: str
            status:
                description:
            ...
            tacacs+_server:
                description:
                    - TACACS+ server name. Source user.tacacs+.name.
                type: str
            type:
                description:
                    - Authentication type.
...
def fortiswitch_user(data, fos):
    ...
    fos.do_member_operation('user_local')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        ...
        if is_secret_field(attribute_name):
            fields["user_local"]['options'][attribute_name]['no_log'] = True
