...
def log_fortianalyzer2_filter(data, fos, check_mode=False):
    ...
    if check_mode:
        ...
        mkey = fos.get_mkey('log.fortianalyzer2', 'filter', filtered_data)
        current_data = fos.get('log.fortianalyzer2', 'filter', mkey=mkey)
...
def fortiswitch_log_fortianalyzer2(data, fos, check_mode):
    fos.do_member_operation('log.fortianalyzer2', 'filter')
