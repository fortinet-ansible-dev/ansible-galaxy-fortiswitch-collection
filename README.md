...
2. Download this collection from galaxy: `ansible-galaxy collection install fortinet.fortiswitch:1.1.0`
...
|----------|:-------------:|:-------------:|:------:|
|6.0.0|1.0.13 |2020/5/26|`ansible-galaxy collection install fortinet.fortiswitch:1.0.13`|
|6.2.0|1.0.10 |2020/5/6|`ansible-galaxy collection install fortinet.fortiswitch:1.0.10`|
|6.2.0|1.1.0 |2020/12/4|`ansible-galaxy collection install fortinet.fortiswitch:1.1.0`|
|6.4.0|1.0.11 |2020/5/11|`ansible-galaxy collection install fortinet.fortiswitch:1.0.11`|
...
* `fortiswitch_execute_clear_dhcp_lease` Clear DHCP Lease list.
* `fortiswitch_execute_delete_sniffer_profile_capture` Delete sniffer profile capture.
* `fortiswitch_execute_download_sniffer_profile` Download sniffer profile.
* `fortiswitch_execute_pause_sniffer_profile_capture` Pause sniffer profile capture.
* `fortiswitch_execute_restore_config` Restore Switch's Configuration.
* `fortiswitch_execute_restore_image` Restore Switch's Image.
* `fortiswitch_execute_sign_data` Sign data with a local certificate.
* `fortiswitch_execute_stage_image` Stage Switch's Image.
* `fortiswitch_execute_start_sniffer_profile_capture` Start sniffer profile capture.
* `fortiswitch_execute_stop_sniffer_profile_capture` Stop sniffer profile capture.
* `fortiswitch_execute_upload_file` Upload file.
